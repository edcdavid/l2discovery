...
require (
	...
	github.com/test-network-function/l2discovery v0.0.0-20220826123443-3f75e429e5c2
...
replace github.com/openshift/ptp-operator => github.com/edcdavid/ptp-operator v1.0.0
